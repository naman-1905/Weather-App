        ...
        <div className="col-span-1 flex flex-col justify-between p-6 bg-[#1c2541] rounded-l-2xl">
          <div>
            <div className="text-lg font-semibold flex items-center justify-between">
              <span>Half Skirmish Weather App</span>
              {aqi && (
                <span
              ...
              >
                ...
                <XAxis
                  ...
                  tickFormatter={(val) => {
                    ...
                    return `${floatHour.toFixed(1)} ${meridian.toLowerCase()}`;
                  }}
                />
                ...
                <Area type="monotone" dataKey="temp" stroke="none" fill="url(#tempGradient)" />
                <Line type="monotone" dataKey="temp" stroke="#38bdf8" strokeWidth={2} dot={{ fill: "#38bdf8" }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-7 gap-3">
              {history7d.map((day, idx) => (
                <div key={idx} className="bg-[#1c2541] rounded-xl px-3 py-4 text-center">
